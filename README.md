...
### `/home/admin/weather_collector.py`
Holt aktuelle Wetterdaten von Open-Meteo (kostenlos, kein API-Key) für Frankfurt (50.1109, 8.6821) und schreibt in InfluxDB (Measurement: `weather`, Bucket: `waerme`).
